...
- 003_benchmark provides benchmarking experiments using external data sourced from the "https://github.com/microsoft/csuite" repository for further validation. The results for the individual experiments are shown, and the datasets are located in data/silver. Experiments are: nonlin_simpson, symprod_simpson, large_backdoor, and weak_arrows.
